    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonsCompleted", x => new { x.StudentId, x.LessonId });
                    table.ForeignKey(
                        name: "FK_LessonsCompleted_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonsCompleted_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_McqQuizOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_McqQuizOptions_QuizQuestions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserQuizAnswer", x => new { x.QuizQuestionId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserQuizAnswer_QuizQuestions_QuizQuestionId",
                        column: x => x.QuizQuestionId,
                        principalTable: "QuizQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserQuizAnswer_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "LessonsCompleted",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_McqQuizOptions_QuestionId",
                table: "McqQuizOptions",
                column: "QuestionId");
